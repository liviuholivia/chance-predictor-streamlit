...
st.markdown("""<p style='text-align:center;'>האלגוריתם מתבסס על ניתוח חכם של 50 ההגרלות האחרונות ומכוון לנבא את ההגרלה הבאה הצפויה.<br> נבנה על ידי ליביו הוליביה.</p>""", unsafe_allow_html=True)
...
st.markdown("""
- האלגוריתם מתבסס על ניתוח חכם של 50 ההגרלות האחרונות ומכוון לנבא את ההגרלה הבאה.
- העלה קובץ CSV אם יש.
